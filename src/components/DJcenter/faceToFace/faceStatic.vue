     ...
     <el-card class="boxCard" style="margin-top: 20px">
      <div> 
        ...
        <div>
          <!-- 柱状图 -->
          <div class="dateBox">
           <el-select style="width: 120px;margin-right: 20px" v-model="form04.dateType" @change="selectChange('form04')">
              <el-option v-for="item in options" :label="item.label" :value="item.value"></el-option> 
           </el-select>  
           <el-date-picker
              :editable="false"
              v-model="form04.startDate"
              :type="form04.dateType01"
              :placeholder="form04.datePlaceHolder01">
            </el-date-picker>
            <el-date-picker
              :editable="false" 
              v-model="form04.endDate"
              :type="form04.dateType01"
              :placeholder="form04.datePlaceHolder02">
            </el-date-picker>
            <el-button type="primary" @click="searchData">查询</el-button>
            <el-button type="primary" @click="resetForm">重置</el-button>
        </div>
        <div class="flexBox_3"> 
        <div class="barBox" style="flex: 1">
            <div v-loading="barLoading" id="tabOneBar_4" style="width: 100%;height: 300px"></div>
        </div>
        <div class="pieBox" style="flex: 1">
            <div v-loading="pieLoading01" id="tabOnePie_4"></div> 
        </div> 
        <div class="pieBox" style="flex: 1">
            <div v-loading="pieLoading01" id="tabOnePie_5"></div> 
        </div> 
        </div>
        </div>
      </div> 
...
export default{
  ...
  methods:{
        ...
        getBarData(){
          that.getTabOneBar({},'tabOneBar','会议数柱状图');
          that.getTabOneBar({},'tabOneBar_2','党建数柱状图');
          that.getTabOneBar({},'tabOneBar_3','面谈数柱状图');
          that.getTabOneBar({},'tabOneBar_4','矛盾调处数柱状图');
        ...
        getTerminalData(){
          that.getTabOnePie_1({},'tabOnePie_1','部门会议占比');
          that.getTabOnePie_1({},'tabOnePie_2','部门党建占比');
          that.getTabOnePie_1({},'tabOnePie_3','部门面谈占比');
          that.getTabOnePie_1({},'tabOnePie_4','部门矛盾调处占比');
          that.getTabOnePie_1({},'tabOnePie_5','矛盾处理占比');
