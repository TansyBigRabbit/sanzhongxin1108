    ...
    methods: { 
          ...
          if(res.data.errorCode==0){  
           ...
           _this.$router.push({
              ...
              params:{
               ...
               petitionInfo:_this.petitionArr[0]
              }
           });
        }else{
      ...
      readCard(){
       ...
       if(!window.WebSocket){ 
        ...
        _this.checkRoom(this.userinfoExtend.idCard); 
